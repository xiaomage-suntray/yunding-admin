<template lang="pug">
    .d2-theme-header-menu(ref="page" :class="{'is-scrollable': isScroll}" flex="cross:center")
        .d2-theme-header-menu__content(ref="content" flex-box="1" flex)
            .d2-theme-header-menu__scroll( ref="scroll" flex-box="0" :style="'transform: translateX(' + currentTranslateX + 'px);'")
        ...
        .d2-theme-header-menu__prev(v-if="isScroll" flex-box="0" @click="scroll('left')" flex="main:center cross:center")
            i.el-icon-arrow-left
        .d2-theme-header-menu__next(v-if="isScroll" flex-box="0" @click="scroll('right')" flex="cross:center")
...
<script>
  ...
  methods: {
    ...
    checkScroll () {
        let contentWidth = this.$refs.content.clientWidth, scrollWidth = this.$refs.scroll.clientWidth;
