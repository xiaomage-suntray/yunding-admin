 ...
 * 工作流地址
 */
service.adornActivityUrl = (actionName) => {
    return process.env.VUE_APP_ACTIVITY + actionName
}
/**
 * 上传文件地址
 */
service.adornFileUrl = (actionName) => {
    return process.env.VUE_APP_FILE + actionName
}
